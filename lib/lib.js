...
$(function() {
	...
	Sk.externalLibraries = {
		...
		csv: {
			path:'lib/skulpt/csv/__init__.js',
			dependencies: []
		}
		};
	...
	var changeOutput = function() {
		if($('#chk_embed_output').is(":checked")) {
		...
		var outputHolder = $('#chk_embed_output').is(":checked")? $('#code_output_parent') : outputHolder = $('#output_holder');
		if(outputHolder) {
	...
	$('#chk_embed_output').on('change', changeOutput);
	changeOutput();
